...
implementation of only defecting agent
...
class OnlyDefectAgent(Agent):
    def __init__(
        self, env, config, state_manager, name="onlyd", seed_modifier=0, verbose=False
    ):
        ...
        if verbose:
            print("[OnlyDefect: Agent] Initialised")
